...
- `npx storybook@latest automigrate --config-dir libs/mobile/shared/ui/new/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/mobile/create/feature/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/mobile/create/ui/.storybook --renderer @storybook/angular`
